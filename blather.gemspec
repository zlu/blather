...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/blather/server/client.rb",
    "lib/blather/server/stream.rb",
    "lib/blather/server/stream/parser.rb",
    "lib/blather/stanza.rb",
    "lib/blather/stanza/dialback.rb",
    ...
    "lib/blather/stanza/iq/muc/admin.rb",
    "lib/blather/stanza/iq/muc/owner.rb",
    ...
    "lib/blather/stanza/muc/invite.rb",
    "lib/blather/stanza/muc/join.rb",
